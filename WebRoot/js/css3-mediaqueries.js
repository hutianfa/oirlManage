...
ua.version = (ua.toString().toLowerCase()
...
var cssHelper = function() {
	...
	var d = function() {
		...
		for (var u = 0; u < s.length; u++) {
			var a = s[u];
			if (a.getAttribute("rel").indexOf("style") > -1 && a.href
					&& a.href.length !== 0 && !a.disabled) {
				r[r.length] = a
			}
		}
		if (r.length > 0) {
			...
			var v = function(t) {
				...
				f(n, function(r) {
							r = l(r).replace(
									e.RELATIVE_URLS,
									"url(" + n.substring(0, n.lastIndexOf("/"))
											+ "/$1)");
							t.cssHelperText = r;
							d()
						}, d)
...
domReady(function() {
			...
			var i = function() {
				...
				t.id = e;
				var n = cssHelper.addStyle("@media all and (width) { #" + e
			...
			var s = function() {
				...
				t.style.cssText = "position:absolute;top:-9999em;left:-9999em;"
			...
			var u = function(e, t) {
				...
				if ("device-width" === e.substring(r - 12, r)) {
					...
					return u === "aspect-ratio"
							&& screen.width * a[1] === screen.height * a[0]
				} else if ("color-index" === e.substring(r - 11, r)) {
					var h = Math.pow(2, screen.colorDepth);
					if (t !== null) {
						if (u === "absolute") {
							return i && h >= a || s && h < a || !i && !s
									&& h === a
						} else {
							return false
						}
			...
			var f = function(e, t) {
				...
				if (l.length > 0) {
					r[r.length] = cssHelper.addStyle("@media " + l.join("")
									+ "{" + e.getCssText() + "}", t, false)
				}
			};
			var l = function(e, t) {
